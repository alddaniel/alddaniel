...
export const CompletedAppointmentsModal: React.FC<CompletedAppointmentsModalProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Histórico de Compromissos Concluídos">
      <div>
        <div className="mb-4">
        ...
        <div className="space-y-3 max-h-[60vh] overflow-y-auto pr-2">
          {filteredAppointments.length > 0 ? (
              ...
              <div key={app.id} className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg flex items-center justify-between gap-4">
                <div className="flex-grow">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Concluído em: {app.end.toLocaleDateString('pt-BR', { dateStyle: 'medium' })}
                  </p>
            ...
            <div className="text-center py-10 text-gray-500 dark:text-gray-400">
              <p>Nenhum compromisso concluído encontrado.</p>
            </div>
          )}
        </div>
      </div>
